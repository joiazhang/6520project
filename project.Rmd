...
- Comparison of different learning rates, dimensions
...
# 
# pred_df$full = plot_prediction_error(betahats, beta, X, Y, title="Adaptive gradient descent (Adagrad)", type="prediction")
# est_df$full = plot_prediction_error(betahats, beta, X, Y, title="Adaptive gradient descent (Adagrad)", type="estimation")
# 
# plot_betas(betahats, beta, nonzero_indexes, nonzero=T)
# plot_betas(betahats, beta, nonzero_indexes, nonzero=F)
```
